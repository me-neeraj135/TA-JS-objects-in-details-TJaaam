...
myFunction(); // Output//  Window {0: Window, window: Window, self: Window, document: document, name: '', location: Location, …}
...
myObject.someMethod(); //Value Of This// myObject{someMethod}
...
person1.displayName(); // Output  //Name: John Reed
...
outerFn()();
// VM386:3 Uncaught ReferenceError: innerItem is not defined
// -----------
...
let object = {
  ...
  doubleArrow: function () {
    ...
    return this.dataDouble.map(item => {
      console.log(this); // Output ???  {data: Array(3), dataDouble: Array(3), double: ƒ, doubleArrow: ƒ}
      return item * 2; // [2,4,6]
    });
  },
};
...
console.log(getSecondData()); // Output and why ???   2 because we have bound the obj1 with obj2.
...
newCall(); // output ???   Hey, undefined just calle
